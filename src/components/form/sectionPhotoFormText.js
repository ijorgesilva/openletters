...
export default function SectionPhotoFormText( { formIframeUrl, formTitle, formContent, photoContentTitle, photoContentText, id, photoImageBackground, backgroundClassName, photoClassName, ...props} ) {

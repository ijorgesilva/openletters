        ...
        {name: 'About', link: '#', megamenu: true,
            submenu: [
                ...
                {name: 'Connect', link:'#', header: true,
                    submenu: [
                        {name: 'My.Victory', link: 'https://members.victoryatl.com/'},
                        {name: 'Small Groups', link: '/global/p/smallgroups' },
        ...
        {name: 'Grow', link:'', megamenu: true,
            submenu: [
                ...
                {name: 'Small Groups', link:'#', header: true,
                    submenu: [
                        {name: 'About Groups', link: '/global/p/smallgroups'},
                        {name: 'Find a Group', link: 'https://members.victoryatl.com/findagroup', target: '_blank'},
                        {name: 'Host a Group', link: '/global/p/smallgroups/host', target: '_blank'},
                        {name: 'Leader Login', link: 'https://members.victoryatl.com/Login?returnurl=%2fMyAccount', target: '_blank'},
                    ]
                },
